...
$resultado = match (true){
    $numero === "01:00" => "una de la mañana",
    $numero === "02:00" => "dos de la mañana",
    $numero === "03:00" => "tres de la mañana",
    $numero === "04:00" => "cuatro de la mañana",
    $numero === "05:00" => "cinco de la mañana",
